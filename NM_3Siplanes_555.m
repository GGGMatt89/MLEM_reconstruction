...
DATA_TYPE = 'IPNL';
DATA_FILE ='/home/collat/fontana/reconstruction_MLEM/analysis_output/geometryStudy/3Siplanes/18-01-05_15-58_10MGamma_keV555_MLEM_TIMING_200MBq.txt'; 
SM_DIR = '/home/collat/fontana/reconstruction_MLEM/reconstruction_output/Matrix/';        % directory to write the system matrix
SENSITIVITY_FILE = '';
RESULTS_DIR = '/home/collat/fontana/reconstruction_MLEM/reconstruction_output/Results/geometryStudy/3Siplanes/555keV/';           % directory with the results
...
if (ENERGY_FLAG==2)            % known total energy
  ENERGY_TOTAL=555;           % the total energy, keV
end
