...
DATA_TYPE = 'IPNL';
DATA_FILE ='/home/collat/fontana/reconstruction_MLEM/analysis_output/geometryStudy/5Siplanes/17-11-15_11-41_10MGamma_keV1524_MLEM_TIMING_200MBq.txt'; 
SM_DIR = '/home/collat/fontana/reconstruction_MLEM/reconstruction_output/Matrix/';        % directory to write the system matrix
SENSITIVITY_FILE = '';
RESULTS_DIR = '/home/collat/fontana/reconstruction_MLEM/reconstruction_output/Results/geometryStudy/5Siplanes/1524keV/';           % directory with the results
...
if (ENERGY_FLAG==2)            % known total energy
  ENERGY_TOTAL=1524;           % the total energy, keV
end
